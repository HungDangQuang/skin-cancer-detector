...
|---|---|---|---|---|---|
| `kd_maxvit_base_to_fastvit_sa12` | `kd_convnextv2_base_to_mobilenetv4_conv_medium` | +0.0017 [-0.0009, +0.0044] | +0.0159 [-0.0082, +0.0397] | +0.0016 [-0.0010, +0.0044] | +0.0033 [-0.0093, +0.0166] |
...
|---|---|---|---|---|---|---|
| `kd_maxvit_base_to_fastvit_sa12` | `kd_convnextv2_base_to_mobilenetv4_conv_medium` | isic2024 | +0.0060 [-0.0046, +0.0170] | -0.0026 [-0.0281, +0.0198] | +0.0038 [-0.0047, +0.0117] | +0.0098 [-0.0400, +0.0658] |
| `kd_maxvit_base_to_fastvit_sa12` | `kd_convnextv2_base_to_mobilenetv4_conv_medium` | pad_ufes_20 | +0.0145 [-0.0057, +0.0338] | +0.0202 [-0.0085, +0.0495] | +0.0032 [-0.0059, +0.0121] | +0.0667 [-0.0387, +0.1557] |
