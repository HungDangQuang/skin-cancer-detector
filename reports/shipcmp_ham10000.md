...
|---|---|---|---|---|---|
| `kd_maxvit_base_to_fastvit_sa12` | `kd_convnextv2_base_to_mobilenetv4_conv_medium` | +0.0269 [+0.0212, +0.0330] * | +0.0374 [+0.0245, +0.0495] * | +0.0184 [+0.0146, +0.0221] * | +0.0339 [+0.0144, +0.0515] * |
