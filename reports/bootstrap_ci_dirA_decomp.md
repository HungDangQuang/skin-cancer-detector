...
| `kd_efficientnetv2_m_to_fastvit_sa12__rkd` | 5 | 0.9832 [0.9757, 0.9897] | 0.6102 [0.5504, 0.6705] | 0.1841 [0.1766, 0.1904] | 0.9527 [0.9279, 0.9750] |
...
| `kd_efficientnetv2_m_to_mobilenetv4_conv_medium__rkd` | 5 | 0.9780 [0.9695, 0.9856] | 0.5935 [0.5325, 0.6532] | 0.1790 [0.1708, 0.1865] | 0.9461 [0.9210, 0.9692] |
...
| `kd_efficientnetv2_m_to_fastvit_sa12__rkd` | `kd_efficientnetv2_m_to_fastvit_sa12` | +0.0013 [-0.0008, +0.0033] | +0.0107 [-0.0011, +0.0231] | +0.0013 [-0.0009, +0.0032] | +0.0050 [-0.0016, +0.0129] |
...
| `kd_efficientnetv2_m_to_mobilenetv4_conv_medium__rkd` | `kd_efficientnetv2_m_to_mobilenetv4_conv_medium` | +0.0071 [+0.0032, +0.0112] * | +0.0120 [-0.0044, +0.0297] | +0.0069 [+0.0031, +0.0109] * | +0.0108 [-0.0009, +0.0226] |
...
|---|---|---|---|---|---|
| `kd_efficientnetv2_m_privileged_to_fastvit_sa12` | `kd_efficientnetv2_m_to_fastvit_sa12__rkd` | +0.0002 [-0.0022, +0.0027] | -0.0112 [-0.0286, +0.0075] | +0.0003 [-0.0021, +0.0027] | +0.0041 [-0.0068, +0.0167] |
| `kd_efficientnetv2_m_privileged_to_mobilenetv4_conv_medium` | `kd_efficientnetv2_m_to_mobilenetv4_conv_medium__rkd` | +0.0001 [-0.0049, +0.0054] | -0.0218 [-0.0427, +0.0032] | +0.0002 [-0.0047, +0.0055] | -0.0041 [-0.0168, +0.0083] |
