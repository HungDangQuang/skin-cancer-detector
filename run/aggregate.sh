...
#
# Usage:  bash run/aggregate.sh RUN_DIR=experiments/runs/teacher/efficientnet_b4
...
: "${RUN_DIR:?RUN_DIR env var required, e.g. RUN_DIR=experiments/runs/teacher/efficientnet_b4}"
